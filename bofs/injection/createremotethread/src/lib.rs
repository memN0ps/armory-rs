//! # CreateRemoteThread Injection BOF
//!
//! Injects shellcode into a remote process using the classic
//! `OpenProcess` -> `VirtualAllocEx` -> `WriteProcessMemory` ->
//! `VirtualProtectEx` -> `CreateRemoteThread` technique.
//! ## MITRE ATT&CK
...
fn main(args: *mut u8, len: usize) {
    ...
    println!("SUCCESS - remote thread created.");
