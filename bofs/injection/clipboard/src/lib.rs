//! # Clipboard Injection BOF
//!
//! Injects shellcode into a remote process using a clipboard-based
//! target process via `CreateRemoteThread`.
//!
//! `VirtualAllocEx` -> `WriteProcessMemory` -> `VirtualProtectEx` ->
//! clipboard-based technique.
//! ## MITRE ATT&CK
...
fn main(args: *mut u8, len: usize) {
    ...
    println!("SUCCESS - clipboard injection variant, remote thread created.");
