//! # Service Control Injection BOF
//!
//! Injects shellcode into a remote process using a service control
//! manager-based injection technique. This variant abuses the SCM
//! to create a temporary service that triggers shellcode execution
//! in the target process.
//!
//! `VirtualAllocEx` -> `WriteProcessMemory` -> `VirtualProtectEx` ->
//! service control-based technique.
//! ## MITRE ATT&CK
...
fn main(args: *mut u8, len: usize) {
    ...
    println!("SUCCESS - svcctrl injection variant, remote thread created.");
