...
fn build_tgs_req(
    ...
    let kdc_opts = 0x40810012u32.to_be_bytes(); // forwardable|renewable|canonicalize|renewable-ok|renew
...
fn main(args: *mut u8, len: usize) {
    ...
    if len == 0 {
        eprintln!("[X] /ticket:BASE64 required");
        return;
    }
    ...
    let service = format!("krbtgt/{}", domain);
