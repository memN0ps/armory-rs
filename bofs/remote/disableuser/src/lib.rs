//! # Disable User BOF
//!
//! Disables a user account by setting the UF_ACCOUNTDISABLE flag
//! via NetUserGetInfo (level 1) and NetUserSetInfo (level 1008).
//!
//! ## MITRE ATT&CK
...
fn main(args: *mut u8, len: usize) {
    ...
    let new_flags = current_flags | UF_ACCOUNTDISABLE;
    ...
    if status == 0 {
        println!("SUCCESS: User '{}' disabled.", username);
    } else {
