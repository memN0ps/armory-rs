...
use windows_sys::Win32::{
    ...
    Storage::FileSystem::{
        FILE_ATTRIBUTE_DIRECTORY, FindClose, FindFirstFileW, FindNextFileW, GetFileAttributesExW,
        GetFileExInfoStandard, WIN32_FILE_ATTRIBUTE_DATA, WIN32_FIND_DATAW,
    },
...
fn metadata_from_parts(attributes: u32, high: u32, low: u32) -> Metadata {
    Metadata {
        ...
        size: ((high as u64) << 32) | low as u64,
    }
}
