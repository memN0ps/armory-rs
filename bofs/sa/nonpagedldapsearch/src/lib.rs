//! # Non-Paged LDAP Search BOF
//!
//! Performs a simple (non-paged) LDAP search against Active Directory using
//! ldap_search_sA directly. This is a simplified version of ldapsearch that
//! does not use paged result controls.
//!
//! ## MITRE ATT&CK
