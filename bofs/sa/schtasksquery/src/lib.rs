//! # Scheduled Tasks Query BOF
//!
//! Queries a specific scheduled task on a local or remote host by invoking
//! `schtasks /query /tn <taskname> /fo list /v` via `CreateProcessA` and
