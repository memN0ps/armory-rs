...
static SUBCATEGORIES: &[SubCategory] = &[
    SubCategory {
        guid: guid(0x0CCE9215, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Logon",
    },
    SubCategory {
        guid: guid(0x0CCE9216, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Logoff",
    },
    SubCategory {
        guid: guid(0x0CCE9217, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Account Lockout",
    },
    SubCategory {
        guid: guid(0x0CCE921C, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Special Logon",
    },
    SubCategory {
        guid: guid(0x0CCE9235, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "User Account Management",
    },
    SubCategory {
        guid: guid(0x0CCE9237, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Security Group Management",
    },
    SubCategory {
        guid: guid(0x0CCE9236, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Computer Account Management",
    },
    SubCategory {
        guid: guid(0x0CCE9228, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Sensitive Privilege Use",
    },
    SubCategory {
        guid: guid(0x0CCE9229, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Non Sensitive Privilege Use",
    },
    SubCategory {
        guid: guid(0x0CCE921B, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "File System",
    },
    SubCategory {
        guid: guid(0x0CCE921D, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Registry",
    },
    SubCategory {
        guid: guid(0x0CCE9222, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Handle Manipulation",
    },
    SubCategory {
        guid: guid(0x0CCE922B, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Process Creation",
    },
    SubCategory {
        guid: guid(0x0CCE922C, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Process Termination",
    },
    SubCategory {
        guid: guid(0x0CCE922F, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Audit Policy Change",
    },
    SubCategory {
        guid: guid(0x0CCE9230, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Authentication Policy Change",
    },
    SubCategory {
        guid: guid(0x0CCE923B, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Directory Service Access",
    },
    SubCategory {
        guid: guid(0x0CCE923C, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Directory Service Changes",
    },
    SubCategory {
        guid: guid(0x0CCE9240, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Credential Validation",
    },
    SubCategory {
        guid: guid(0x0CCE9242, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
        name: "Kerberos Authentication Service",
    },
    SubCategory {
        guid: guid(0x0CCE9241, 0xC069, 0x4A26, [
            0xA9, 0x68, 0x6F, 0x1A, 0x46, 0x2D, 0x79, 0x1A,
        ]),
...
fn main() {
    ...
    for sub in SUBCATEGORIES.iter() {
        unsafe {
            ...
            let ok = AuditQuerySystemPolicy(&sub.guid as *const [u8; 16], 1, &mut policies);
